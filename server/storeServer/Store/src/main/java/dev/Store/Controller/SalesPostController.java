...
//    public JSONObject createPostReview(JSONObject jsonObject){return salesPostService.createPostReview(jsonObject);}
...
//        }
//        if("salesPostReviewCreate".equals(action)){
//            JSONObject resultJsonObject = createPostReview(jsonObject);
//            sendMessage(requestId, resultJsonObject);
//        }
